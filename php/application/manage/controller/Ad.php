...
class Ad extends Base
{
	...
	public function index()
    {
        ...
        //页面头信息设置
        $pageData['isback']             = 0;
        $pageData['title1']             = '广告列表';
        $pageData['title2']             = '广告索引与管理';
	...
	public function add()
    {
        ...
        //页面头信息设置
        $pageData['isback']             = 1;
        $pageData['title1']             = '广告详情';
        $pageData['title2']             = '广告添加与管理';
        $pageData['notice']             = [];
    ...
    {
        //广告位置列表
        $defaultData['pos_list']        = $this->pos_list();

        return $defaultData;
    }

    private function pos_list()
    {
        //获取列表数据
        $parame['uid']      = $this->uid;
        $parame['hashid']   = $this->hashid;
        ...
        //请求数据
        $apiUrl             = 'Api/AdPosition/listData';
        $res                = $this->apiData($parame,$apiUrl,false);
        $data               = $this->getApiData() ;
