...
class Base2 extends Controller
{
    ...
    protected function getListNote($listid = '')
    {
        ...
        $parame['hashid']       = $this->hashid;
        $parame['id']           = $listid;
        $res                    = $this->apiData($parame,'Admin/Devlist/detailData');
        ...
        $parame['page']         = 1;
        $parame['search']       = '';
        $res                    = $this->apiData($parame,'Admin/Devlist/listData');
    ...
    protected function getFormFields($formId,$isEdit)
    {
        ...
        $parame['hashid']       = $this->hashid;
        $parame['id']           = $formId;
        $res                    = $this->apiData($parame,'Admin/Devform/detailData');
        $info                   = $res ? $this->getApiData() : [];
        ...
        $parame['page']         = 1;
        $parame['search']       = '';
        $res                    = $this->apiData($parame,'Admin/Devform/listData');
    ...
    protected function helper($parame,$mName,$cName,$aName)
    {
        ...
        $data           = $object->isInside($parame,$aName) ;
    ...
    //获取列表设置
    protected function getListNote2($listNote = [])
    {
        //初始化数据
        $data                   = ['info'=>[],'search'=>[],'thead'=>[]];
